...
/**
 * 레시피 리뷰 목록 — ?recipeId=&page=&size= →
 * { content:[ReviewItem], page, size, totalElements, totalPages, ratingStats:{avg, dist} }
 */
