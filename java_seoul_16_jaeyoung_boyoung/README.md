...
> 백엔드 기준. 상세 명세: [`naengkeum/src/docs/api.md`](naengkeum/src/docs/api.md) · ERD: [`naengkeum/src/docs/erd.md`](naengkeum/src/docs/erd.md)
...
Flyway 마이그레이션(`naengkeum/src/main/resources/db/migration`)으로 관리합니다.
